...
3. reviews
4. studies with the focus on several fungal infections (invasive fungal infection)
5. trial pre-results
6. systematic reviews
7. guidelines 
8. therapeutic drug monitoring
9. studies on various species like dogs or mice 
10. clinical investigations focusing only om pediatric patients
11. studies on aspergilloma
12. studies describing clinical characteristics of invasive aspergillosis
13. publications without abstracts
...
theRefs <- effort_distribute(data_eng, reviewers = c("Eva"), initialize = TRUE)
write.csv(theRefs, file = "EvaRefs.csv")
theRefs_unscreened <- abstract_screener("EvaRefs.csv", aReviewer = "Eva", unscreenedColumnName = "INCLUDE", unscreenedValue = "not vetted", highlightKeywords = "aspergillosis")
